...
python train_global.py --name siggraph_class --sample_p 1.0 --niter 15 --niter_decay 0 --classification --load_model --phase train --which_model_netG siggraphglobal
...
python train_global.py --name siggraph_reg_global --sample_p .125 --niter 10 --niter_decay 0 --lr 0.00001 --load_model --phase train --which_model_netG siggraphglobal
...
python train_global.py --name siggraph_reg_global2 --sample_p .125 --niter 5 --niter_decay 0 --lr 0.000001 --load_model --phase train --which_model_netG siggraphglobal
